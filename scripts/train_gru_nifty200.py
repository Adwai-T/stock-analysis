...
MODEL_PATH = MODEL_DIR / "gru_nifty200.h5"          # renamed for GRU
SCALER_PATH = MODEL_DIR / "gru_nifty200_scaler.npz" # renamed for GRU
...
def build_dataset():
    ...
    X_list = []   # <-- fixed initialization
    y_list = []   # <-- fixed initialization
