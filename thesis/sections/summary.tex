...
\begin{itemize}
  ...
  \item Evaluating performance across single-company training, index-based datasets, and full-market datasets
  \item Testing models both with raw OHLCV inputs and with engineered technical indicator feature sets
