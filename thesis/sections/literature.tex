...
Recent literature reflects a clear evolution in computational techniques used for stock market prediction, progressing from traditional machine learning approaches toward deep learning architectures and more recently, large language models (LLMs). Early studies such as Huang et al. \cite{Huang2022PredictiveModeling} demonstrated that classical machine learning techniques could model global stock movements, although their performance was sensitive to market noise and lacked the ability to capture long-term temporal dependencies. As the limitations of linear and tree-based models became evident, research attention shifted toward neural architectures.

Deep learning–based systems introduced improvements in extracting high-dimensional patterns from financial time-series data. Jin \cite{Jin2024CNNStockMarket} explored hybrid CNN-driven architectures capable of learning temporal and structural dependencies from stock indicators, showing measurable improvements over purely statistical techniques. Similarly, Balasubramanian et al. \cite{Balasubramanian2024StockMarketAnalysis} expanded modeling scope by incorporating biometric behavioral features, reflecting a growing trend toward multi-modal forecasting frameworks.

Parallel advances have also focused on sentiment and language-aware prediction pipelines. Khanpuri et al. \cite{Khanpuri2024SentimentAnalysis} demonstrated the predictive impact of textual and fundamental sentiment, while Cilingiroglu \cite{Cilingiroglu2025SentimentChangingPrice} identified sentiment-driven modeling as one of the most disruptive emerging forces in financial forecasting. This shift toward contextual reasoning aligns with the rapid emergence of LLM-based approaches. Recent work by Cao et al. \cite{Cao2024LLMStock} and Huang et al. \cite{Huang2025DeepLearning} highlights the ability of LLMs to process financial narratives, macroeconomic reports, and unstructured market discourse, marking a transition toward models that learn not only numerical dynamics but also semantic content.

Broader reviews such as Zhu \cite{Zhu2025StockPredictionReview} and Smarte and Ho \cite{Smarte2021ReviewOfMachineLearning} underscore that modern forecasting systems increasingly rely on hybrid methods that combine time-series architectures, sentiment processing, multimodal features, and reinforcement-based decision frameworks. Meanwhile, work by Gupta \cite{Gupta2024RoleOfAI} and Mokhtari et al. \cite{Mokhtari2021ImpactOfAI} emphasizes the integration of AI into trading strategy optimization and risk management rather than solely predictive modeling.

Finally, emerging discussions situate these developments within larger digital finance ecosystems. Lu \cite{Lu2024FinancialArchitecture} describes how blockchain-based market infrastructure and open financial systems may accelerate data transparency, enabling AI-driven forecasting and algorithmic execution to operate in increasingly decentralized financial environments.

Across these studies, the literature indicates a convergence toward deep, adaptive, and context-aware forecasting models, while also emphasizing the importance of hybrid learning frameworks capable of integrating structured price data with qualitative and behavioral signals.
...
\small
\begin{tabular}{|p{2.2cm}|p{3.8cm}|p{2.2cm}|p{4.8cm}|}
\hline
